...
def generate_from_annotations(annotations_fpath, num_imgs, img_size, max_objects_in_each_img, object_size, object_transformations, fpath):
  ...
  try:
    ...
    pass
  generate(num_imgs, img_size, extract_objects(annotations_fpath, save_to_fpath=objects_fpath), max_objects_in_each_img, object_size, object_transformations, fpath)